...
from music.models import BookInstance, Book, Genre, Language, Author
...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self):
        response = self.client.get('/music/authors/')
    ...
    def test_view_uses_correct_template(self):
        response = self.client.get(reverse('authors'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'music/author_list.html')
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_book.language.set(language_objects_for_book) # Direct assignment of many-to-many types not allowed.
        test_book.save()
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/music/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'music/bookinstance_list_borrowed_user.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        # Check we used correct template
        self.assertTemplateUsed(response, 'music/book_renew_librarian.html')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/music/author/create/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Check we used correct template
        self.assertTemplateUsed(response, 'music/author_form.html')
