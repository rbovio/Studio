...
urlpatterns = [
    ...
    path('music/', include('music.urls')), # Use include() to add paths from the music application
    path('', RedirectView.as_view(url='music/')), # Add URL maps to redirect the base URL to our application
